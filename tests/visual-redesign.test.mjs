...
assert.match(projects, /projects-intro/, 'Projects should restore the large Selected Work editorial intro');
...
assert.match(experience, /experience-intro/, 'Experience should include the large editorial intro from the mockup');
assert.match(experience, /experience-feature-row/, 'Paris 2024 should sit beside the experience introduction on desktop');
...
assert.match(skills, /capabilities-intro/, 'Capabilities should include the mockup-style editorial intro');
...
assert.match(skills, /tools-panel/, 'Skills should separate tools into their own panel');
assert.match(skills, /languages-panel/, 'Skills should separate language proficiency into its own panel');
assert.match(skills, /highlights-panel/, 'Skills should restore a key-highlights panel');
...
assert.match(contact, /closing-contact-details/, 'Closing CTA should include direct contact rows');
...
assert.match(index, /polish\.css/, 'The final mockup parity layer should load after the base design tokens');
